              ...
              children: [
                ...
                Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Re - password", style: TextStyle(color: MovieColors.lightGrey, fontSize: 20)),
                      TextFormField(
                        validator: (value){
                          if(value!.isEmpty){
                            return "you can't let the field empty";
                        ...
                        style: TextStyle(color: MovieColors.white, fontSize: 24),
                        obscureText: showRePassword? true : false,
                        decoration: InputDecoration(
                            focusColor: MovieColors.yellow,
                            suffix: showRePassword? IconButton(
                              onPressed: (){
                                setState(() {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text("By signing up you agree to our Privacy", style: TextStyle(color: MovieColors.white, fontSize: 16, fontWeight: FontWeight.w500)),
                    SizedBox(height: 6,),
                    InkWell(
                      onTap: (){},
                      child: Text("Policy and Terms", style: TextStyle(color: MovieColors.yellow, fontSize: 16, fontWeight: FontWeight.w500)),),
                  ],
                ),
                SizedBox(height: 60,),
                ...
                Row(
                  children: [
                    Text("Already have an account? ", style: TextStyle(color: MovieColors.white, fontSize: 20)),
                    InkWell(onTap: (){}, child: Text("Sign In", style: TextStyle(color: MovieColors.yellow, fontSize: 20)),)
                  ],
                )
